...
protected:
	...
	void Paint() override;
	void OnGameLoopDone() override;
	bool SnapshotTick() override;
...
private:
	...
	void *last_egl_surface = nullptr; ///< EGL surface handle from last frame; detects surface swap (background→foreground).
