...
*/
    ...
    // Wallpaper service mode support
    ...
    public static Context mServiceContext;     // application context for service mode
    public static String sOverrideLibrary;     // native library path for service mode
    public static String sOverrideFunction;    // entry function name for service mode
    public static String[] sOverrideArguments; // arguments for service mode
    ...
    public static void initialize() {
        ...
        sOverrideSurface = null;
        sServiceMode = false;
        mServiceContext = null;
        sOverrideLibrary = null;
        sOverrideFunction = null;
        sOverrideArguments = null;
    }

    /**
     * Initialize SDL for use from a WallpaperService (no Activity).
     * Must be called after native libraries are loaded.
     */
    public static void initForService(Context appContext) {
        SDL.setupJNI();
        SDL.initialize();
        sServiceMode = true;
        mServiceContext = appContext;
    ...
    public static void handleNativeState() {
        ...
        if (mNextNativeState == NativeState.RESUMED) {
            boolean canResume;
            if (sServiceMode) {
                canResume = (sOverrideSurface != null);
            } else {
...
//        }
    ...
    public static Surface getNativeSurface() {
        if (sOverrideSurface != null) {
            return sOverrideSurface;
        }
...
class SDLMain implements Runnable {
    ...
    public void run() {
        ...
        if (SDLActivity.sServiceMode) {
            library = SDLActivity.sOverrideLibrary;
            function = SDLActivity.sOverrideFunction;
            arguments = SDLActivity.sOverrideArguments;
        } else {
            library = SDLActivity.mSingleton.getMainSharedObject();
            function = SDLActivity.mSingleton.getMainFunction();
            arguments = SDLActivity.mSingleton.getArguments();
        }
